...
const services: Array<() => Promise<unknown>> = [
  ...
  () => import("../../modules/ai/service/gateway.ts"),
  () => import("../../modules/ai/service/model.ts"),
  () => import("../../modules/ai/service/provider.ts"),
  ...
  () => import("../../modules/base/service/param.ts"),
  ...
  () => import("../../modules/i18n/service/data-field.ts"),
  () => import("../../modules/i18n/service/data-pack.ts"),
  () => import("../../modules/i18n/service/data.ts"),
  () => import("../../modules/i18n/service/lang.ts"),
  () => import("../../modules/i18n/service/pack.ts"),
  () => import("../../modules/project/service/ai-chat.ts"),
  () => import("../../modules/project/service/ai-model.ts"),
  () => import("../../modules/project/service/infra.ts"),
  () => import("../../modules/project/service/kb.ts"),
  () => import("../../modules/project/service/skill.ts"),
...
const adminControllers: Array<{ file: string; load: () => Promise<unknown> }> = [
  { file: "modules/ai/controller/admin/call-log.ts", load: () => import("../../modules/ai/controller/admin/call-log.ts") },
  { file: "modules/ai/controller/admin/model.ts", load: () => import("../../modules/ai/controller/admin/model.ts") },
  { file: "modules/ai/controller/admin/provider.ts", load: () => import("../../modules/ai/controller/admin/provider.ts") },
  ...
  { file: "modules/base/controller/admin/param.ts", load: () => import("../../modules/base/controller/admin/param.ts") },
  ...
  { file: "modules/i18n/controller/admin/data-field.ts", load: () => import("../../modules/i18n/controller/admin/data-field.ts") },
  { file: "modules/i18n/controller/admin/data-pack.ts", load: () => import("../../modules/i18n/controller/admin/data-pack.ts") },
  { file: "modules/i18n/controller/admin/lang.ts", load: () => import("../../modules/i18n/controller/admin/lang.ts") },
  { file: "modules/i18n/controller/admin/pack.ts", load: () => import("../../modules/i18n/controller/admin/pack.ts") },
...
const appControllers: Array<{ file: string; load: () => Promise<unknown> }> = [
  ...
  { file: "modules/base/controller/app/param.ts", load: () => import("../../modules/base/controller/app/param.ts") },
  { file: "modules/i18n/controller/app/pack.ts", load: () => import("../../modules/i18n/controller/app/pack.ts") },
  { file: "modules/project/controller/app/ai-chat.ts", load: () => import("../../modules/project/controller/app/ai-chat.ts") },
  { file: "modules/project/controller/app/ai-model.ts", load: () => import("../../modules/project/controller/app/ai-model.ts") },
  { file: "modules/project/controller/app/infra.ts", load: () => import("../../modules/project/controller/app/infra.ts") },
  { file: "modules/project/controller/app/kb.ts", load: () => import("../../modules/project/controller/app/kb.ts") },
  { file: "modules/project/controller/app/skill.ts", load: () => import("../../modules/project/controller/app/skill.ts") },
